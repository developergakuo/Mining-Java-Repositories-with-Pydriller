...
def calculateChangeBurst(intervalhashesSet, filehashesSet):
    intervalhashes = list(intervalhashesSet)
    filehashes = list(filehashesSet)
    matchedLengths = [0]
    matched = 0
    for index in range(len(filehashes)):
        slice = intervalhashesSet[intervalhashesSet.index(filehashes[index]):]
